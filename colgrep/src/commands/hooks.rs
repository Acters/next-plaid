    ...
    let response = serde_json::json!({
        "hookSpecificOutput": {
            ...
            "additionalContext": concat!(
                ...
                "- Ranking: `--semantic-only` (disable keyword boost) | `--alpha 0.8` (keyword vs semantic weight, default 0.6)\n",
    ...
    let response = serde_json::json!({
        "hookSpecificOutput": {
            ...
            "additionalContext": concat!(
                ...
                "(https://github.com/lightonai/next-plaid) that runs fully locally. ",
                "The user prefers it over Grep/Glob for code search.\n",
                "- Semantic: `colgrep \"error handling\" -k 10`\n",
